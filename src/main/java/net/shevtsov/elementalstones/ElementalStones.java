package net.shevtsov.elementalstones;
...
import net.shevtsov.elementalstones.block.ModBlocks;
import net.shevtsov.elementalstones.event.ItemEventHandler;
import net.shevtsov.elementalstones.item.ModItems;
import org.slf4j.Logger;

// The value here should match an entry in the META-INF/mods.toml file
@Mod(ElementalStones.MOD_ID)
